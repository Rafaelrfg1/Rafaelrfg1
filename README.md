...
My focus is embedded systems and firmware, with a particular interest in aerospace and medical device applications. This fall, I'm joining UW's Society of Advanced Rocket Propulsion(SARP) on the Ground systems team, working on the DAQ subsystem. I'm also building out my hardware and analog design skills through independent projects, including a heartbeat monitor with a tree-stage analog filter front end (currently moving from breadboard validation into a custom PCB layout in Altium) and a negative pressure wound therapy (NPWT) device I helped build and debug as part of a first-year design team, which we later presented to our class for our final project. 
...
## Resume:
[Resume](https://github.com/Rafaelrfg1/Resume/blob/main/Resume_pro_7_29_2026.pdf)
